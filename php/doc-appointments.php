...
<?php include('doc-sidebar.php');?>
    ...
    <a href="appointment-history.php?id=<?php echo $row['p_id']?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this appointment ?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">Cancle</a>
    <?php } else {
